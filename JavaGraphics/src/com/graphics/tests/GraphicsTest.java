...
public class GraphicsTest extends JFrame {
	...
	public GraphicsTest(){
		...
		TRAITS.addTrait(lantern3, new OrientableTrait()).setOrientation(new SimpleOrientation(OrientableTrait.ORIENTATION_TAG));
		cnv.registerObject(lantern3, new Point(400,100,100), ShaderFactory.NONE);
		l3.getLightSource().setDirection(() -> {return TRAITS.getTrait(lantern3, IOrientable.class).get().getOrientation().getForward();});
		...
		TRAITS.addTrait(whale, new PlugableTrait()).registerPlugin(Events.EXPLODE, explode, false);
		...
		TRAITS.addTrait(ship, new OrientableTrait()).setOrientation(new SimpleOrientation(OrientableTrait.ORIENTATION_TAG));
		...
		TRAITS.addTrait(torus, new PlugableTrait()).registerPlugin(Events.EXPLODE, explode, false);
		...
		TRAITS.addTrait(cube, new PlugableTrait());
		...
		TRAITS.addTrait(ball, new TexturableTrait()).addTexture(new BmpTexture("smily")).mapTexture(new OvoidTextureMapper());
		TRAITS.addTrait(ball, new PlugableTrait()).registerPlugin(Events.EXPLODE, explode, false);
		...
		this.addKeyListener(new KeyListener(){
			...
			public void keyTyped(KeyEvent key) {
				if (key.getKeyChar() == 'l') l4.toggle();
					...
					TRAITS.addTrait(movingTarget, new PlugableTrait()).registerPlugin(Events.EXPLODE, explode, false);
